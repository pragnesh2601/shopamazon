            ...
            <!--header start here-->
                <div class="header-main">
                    <div class="header-left">
                            <div class="logo-name">
                                     <a href="{{ url('/') }}"> <h1>{{ config('app.name', 'Laravel') }}</h1> 
                         ...
                         <div class="header-right">
                            ...
                            <div class="profile_details">       
                                @guest 
                                <ul>
                                    <li class="dropdown profile_details_drop"><a class="popup-with-zoom-anim" href="#login-small-dialog"><i class="fa fa-sign-in"></i> {{ __('Login') }}</a></li>
                                    <li class="dropdown profile_details_drop"><a class="popup-with-zoom-anim" href="#register-small-dialog"><i class="fa fa-user"></i> {{ __('Register') }}</a></li>
                                </ul>
                                @else
                                <ul>
                                    <li class="dropdown profile_details_drop">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                            <div class="profile_img">   
                                                <span class="prfil-img"><img src="{{ Auth::user()->getPhoto(30,30) }}" alt=""> </span> 
                                                <div class="user-name">
                                                    <p>{{ Auth::user()->name }}</p>
                                                </div>
...
<div class="copyrights">
    <div class="row">
        <div class="col-xs-12 col-md-6"><p>&copy; {{date('Y')}} {{ config('app.name', 'Laravel') }}. All Rights Reserved.</p></div>
        <div class="col-xs-12 col-md-6"><p>Design by  <a href="{{ url('/') }}" target="_blank">{{ config('app.name', 'Laravel') }}</a> </p></div>
    </div>
     <!-- <p>&copy; {{date('Y')}} {{ config('app.name', 'Laravel') }}. All Rights Reserved | Design by  <a href="{{ url('/') }}" target="_blank">{{ config('app.name', 'Laravel') }}</a> </p> -->
</div> 
            ...
            <div class="menu">
              <ul id="menu" >
                ...
                <li><a href="#"><i class="fa fa-cogs"></i><span>Category</span><span class="fa fa-angle-right" style="float: right"></span></a>
                  <ul>
                    <li><a href="{{ url('/admin/addcategory') }}">Add</a></li>
                ...
                <li><a href="#"><i class="fa fa-cogs"></i><span>Sub Category</span><span class="fa fa-angle-right" style="float: right"></span></a>
                  <ul>
                    <li><a href="{{ url('/admin/addsubcategory') }}">Add</a></li>
                    <li><a href="{{ url('/admin/viewsubcategory') }}">View Sub Category</a></li>                    
                  </ul>
                </li>
                <li><a href="#"><i class="fa fa-shopping-cart"></i><span>Products</span><span class="fa fa-angle-right" style="float: right"></span></a>
                  <ul>
                    ...
                    <li><a href="{{ url('/admin/viewproducts') }}">View Products</a></li>                    
                  </ul>
                </li>
                 <li><a href="#"><i class="fa fa-cog"></i><span>System</span><span class="fa fa-angle-right" style="float: right"></span></a>
                     <ul id="menu-academico-sub" >
                        <li id="menu-academico-avaliacoes" ><a href="{{ url('/admin/profile') }}">Edit Profile</a></li>
                        <li id="menu-academico-boletim" ><a href="{{ url('/admin/settings') }}">Site Settings</a></li>
                     </ul>
                 </li>
              </ul>
            </div>
