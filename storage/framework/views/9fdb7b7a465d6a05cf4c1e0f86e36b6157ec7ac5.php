        ...
        <div class="col-md-6 col-md-offset-3 my-4">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    <form id="LoginForm" method="POST" method="POST" action="<?php echo e(route('register')); ?>" role="form">
                        <?php echo csrf_field(); ?>
                        <fieldset>
                            ...
                            <div class="form-group row">
                                <label for="mobile" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Mobile No.')); ?> <sup class="text-danger">*</sup></label>
                                <div class="col-md-8">
                                    <input id="mobile" type="mobile" class="form-control<?php echo e($errors->has('mobile') ? ' is-invalid' : ''); ?>" name="mobile" value="<?php echo e(old('mobile')); ?>" required>
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-md-6">
                                    <a class="btn btn-md btn-success btn-block pull-right" href="<?php echo e(url('/')); ?>">Return to Home</a>
                                </div>
                            </div>
                        </fieldset>
                    </form>
